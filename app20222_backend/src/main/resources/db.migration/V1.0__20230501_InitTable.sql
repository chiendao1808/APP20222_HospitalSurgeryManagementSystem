...
INSERT INTO "app20222_db"."features" (code, parent_code, parent_id, name, lst_usable_role) VALUES
       ...
       ('STATISTICS_MANAGEMENT', 'SYSTEM', (SELECT id FROM "app20222_db"."features" WHERE code = 'SYSTEM' ORDER BY id DESC LIMIT 1),
        'Báo cáo - Thống kê',
...
INSERT INTO "app20222_db"."features" (code, parent_code, parent_id, name, lst_usable_role)
VALUES ('STATISTICS_DASHBOARD', 'STATISTICS_MANAGEMENT',
        (SELECT id FROM "app20222_db"."features" WHERE code = 'STATISTICS_MANAGEMENT' ORDER BY id DESC LIMIT 1), 'Xem báo cáo dạng Dashboard',
        '{ROLE_SUPER_ADMIN,ROLE_HOSPITAL_ADMIN,ROLE_HOSPITAL_MANAGER}'),
        ('STATISTICS_EXP_SURGERY_SHEET', 'STATISTICS_MANAGEMENT',
        (SELECT id FROM "app20222_db"."features" WHERE code = 'STATISTICS_MANAGEMENT' ORDER BY id DESC LIMIT 1), 'Xuất báo cáo dạng file sheet',
        '{ROLE_SUPER_ADMIN,ROLE_HOSPITAL_ADMIN,ROLE_HOSPITAL_MANAGER,ROLE_DEPARTMENT_ADMIN,ROLE_DEPARTMENT_MANAGER,ROLE_DOCTOR,ROLE_NURSE,ROLE_STAFF}');
